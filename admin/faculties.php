...
<aside class="admin-sidebar">
  ...
  <ul class="admin-nav">
    ...
    <li><a href="faculties.php" class="nav-link active"><i class="fa fa-graduation-cap"></i> Faculties &amp; Depts (14)</a></li>
    ...
    <li class="mt-4 pt-3 border-top border-white border-opacity-10">
      <a href="../Academic/FacultiesAndDepartments/EngineeringAndTechnology.php" target="_blank" class="nav-link text-white-50"><i class="fa fa-arrow-up-right-from-square"></i> Visit Faculties Public</a>
    </li>
