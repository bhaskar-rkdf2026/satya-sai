...
$fpath = 'd:/xampp/htdocs/sssu/satya-sai/Academic/NAAC/CriteriaTwo.php';
...
echo "CriteriaTwo.php rebuilt successfully!\n";

PHP;

file_put_contents('scratch/rebuild_criteria_two.php', $code);
