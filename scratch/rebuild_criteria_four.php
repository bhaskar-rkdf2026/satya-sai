...
$fpath = 'd:/xampp/htdocs/sssu/satya-sai/Academic/NAAC/CriteriaFour.php';
...
echo "CriteriaFour.php rebuilt successfully!\n";

PHP;

file_put_contents('scratch/rebuild_criteria_four.php', $code);
