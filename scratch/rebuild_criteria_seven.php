...
$fpath = 'd:/xampp/htdocs/sssu/satya-sai/Academic/NAAC/CriteriaSeven.php';
...
echo "CriteriaSeven.php rebuilt successfully!\n";

PHP;

file_put_contents('scratch/rebuild_criteria_seven.php', $code);
