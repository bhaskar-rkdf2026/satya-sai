...
$fpath = 'd:/xampp/htdocs/sssu/satya-sai/Academic/NAAC/CriteriaSix.php';
...
echo "CriteriaSix.php rebuilt successfully!\n";

PHP;

file_put_contents('scratch/rebuild_criteria_six.php', $code);
