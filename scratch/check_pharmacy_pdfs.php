<?php
$pharmacy_file = __DIR__ . '/../Download/Scheme/Pharmacy.php';
$content = file_get_contents($pharmacy_file);
...
echo "Total unique PDF links in Pharmacy.php: " . count($unique_links) . "\n\n";
...
foreach ($unique_links as $rel) {
    ...
    if (file_exists($local_path)) {
        ...
        $live_urls = [
            ...
            'https://sssutms.co.in/cms/Areas/Website/Files/Link/SCHEME2021/' . $basename,
        ];
