...
// Fetch dynamic Patents page info & SEO from Admin Panel
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('ResearchPatents') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Patents - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Patents';
