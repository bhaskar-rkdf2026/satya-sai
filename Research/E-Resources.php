...
// Fetch dynamic E-Resources page info & SEO from Admin Panel
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('ResearchEResources') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'E-Resources - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'E-Resources';
