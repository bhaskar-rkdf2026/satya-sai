...
// Fetch dynamic Consultancy Services page info & SEO from Admin Panel
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('ConsultancyServices') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Consultancy Services - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Consultancy Services';
