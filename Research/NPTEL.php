...
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('NPTEL') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'NPTEL - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'NPTEL';
