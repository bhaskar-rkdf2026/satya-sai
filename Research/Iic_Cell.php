...
// Fetch dynamic IIC Cell page info & SEO from Admin Panel
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('Iic_Cell') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'IIC Cell - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'IIC Cell';
