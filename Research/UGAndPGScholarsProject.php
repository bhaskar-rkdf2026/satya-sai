...
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('UGAndPGScholarsProject') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'UG & PG Scholars Project - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'UG & PG Scholars Project';
