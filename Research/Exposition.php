...
$pageSeo = function_exists('get_research_page_info') ? get_research_page_info('Exposition') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Exposition - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Exposition';
