...
$announcements = get_career_announcements(true);

$page_data = $page_info;
$page_title = 'Career Announcements & Guidelines | Sri Satya Sai University (SSSUTMS)';
$banner_title = 'Career Announcements';
        ...
        <div class="syl-card">
          <div class="syl-card-header">
            <h2 class="syl-card-title">
              ...
              Recruitment Guidelines &amp; Announcements
            </h2>
          </div>
          ...
          <div class="syl-card-body">
            ...
            <div class="alert alert-primary bg-light border-primary border-start border-4 rounded-3 p-3 mb-4">
              <div class="d-flex align-items-start gap-3">
                ...
                <div>
                  <h6 class="fw-bold text-dark mb-1">Official Recruitment Notices &amp; Statutory Guidelines</h6>
                  <p class="text-secondary small mb-0">
                    Find updated instructions, qualification criteria, and reservation policy notifications for academic &amp; administrative posts at SSSUTMS.
                  </p>
                </div>
              </div>
            </div>
            ...
            <?php if (empty($announcements)): ?>
              <div class="text-center py-5 text-muted">
                ...
                <p class="small">Please check back regularly for updates regarding faculty recruitment drives.</p>
              </div>
            <?php else: ?>
