...
$pageSeo = function_exists('get_examination_page_info') ? get_examination_page_info('examinations') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Examinations & Results Portal - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Examinations';
