...
$page_info = get_obe_page_info($pageKey, [
    ...
    'heading'        => 'FACULTY OF BASIC & APPLIED SCIENCES',
    ...
    'vision_title'   => 'VISION',
    'vision_text'    => 'The Science faculty envisions itself as a dynamic community of science and mathematics faculty and students engaged in innovative research and learning with global impact.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'To cultivate scientific inquiry, analytical problem-solving, laboratory proficiency, and multidisciplinary fundamental and applied science research.'
]);

$page_data = $page_info;
$page_title = $page_info['meta_title'] ?? ($page_info['page_title'] ?? 'Science - Outcome Based Curriculum - SSSUTMS');
$banner_title = $page_info['banner_title'] ?? 'Science';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'FACULTY OF BASIC & APPLIED SCIENCES'); ?></h3>
