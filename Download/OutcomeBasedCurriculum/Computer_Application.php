<?php
$page_title = 'Computer Application - Outcome Based Curriculum - SSSUTMS';
$banner_title = 'Computer Application';
...
$curricula = [
    [
        ...
        'filter' => 'mca',
        'items' => [
            ['title' => 'Master of Computer Applications (MCA)', 'file' => 'MCA.pdf', 'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/Curriculum/MCA.pdf'],
        ]
    ],
    [
        ...
        'filter' => 'bca',
        'items' => [
            ['title' => 'Bachelor of Computer Applications (BCA)', 'file' => 'BCA.pdf', 'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/Curriculum/BCA.pdf'],
        ]
    ]
];
?>
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #002B5B;">FACULTY OF COMPUTER APPLICATIONS</h3>
          ...
          <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
              <div class="card h-100 border-0 rounded-4 p-4 shadow-sm" style="background: linear-gradient(135deg, #fffbf0 0%, #fff6e6 100%); border-left: 5px solid #e67e23 !important;">
                ...
                <p class="small text-secondary mb-0 lh-base">
                  “To achieve excellence in teaching-learning, Research and development activities by creating technically capable and devoted Software engineers to serve their surroundings with pride”.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
            <div class="d-flex flex-wrap align-items-center gap-2" id="categoryFilters">
              <button type="button" class="ca-tab-btn active" data-filter="all">All Programs (2)</button>
              <button type="button" class="ca-tab-btn" data-filter="mca">MCA (1)</button>
              <button type="button" class="ca-tab-btn" data-filter="bca">BCA (1)</button>
            </div>
          ...
          <div class="table-responsive ca-table-wrapper">
            <table class="ca-table obe-table">
              <thead>
                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const filterButtons = document.querySelectorAll('#categoryFilters .ca-tab-btn');
