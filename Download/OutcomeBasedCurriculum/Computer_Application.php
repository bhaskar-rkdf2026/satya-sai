<?php
$page_title = 'Faculty of Computer Applications - Outcome Based Curriculum - SSSUTMS';
$banner_title = 'Faculty of Computer Applications';
        ...
        <div class="academic-card bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.5rem;">Faculty of Computer Applications</h3>
            ...
            <div class="col-md-6">
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #0b2545;">
                ...
                <p class="text-secondary small mb-0 lh-base" style="font-style: italic;">
                  "To be a globally recognized world class Institute for imparting IT related knowledge, Skill and attitude for entering into world of work and allied areas."
                </p>
              </div>
            </div>
              ...
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #475569;">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2" style="font-size: 0.84rem; color: #475569;">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="lh-sm">To achieve excellence in teaching-learning, Research and development activities by creating technically capable and devoted Software engineers to serve their surroundings with pride.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">Provide industry-aligned computational skills, full-stack development, and artificial intelligence foundations.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">Promote ethical software design and lifelong learning among computer application graduates.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <table class="table table-hover align-middle mb-0 standard-table obe-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">MCA (Master of Computer Applications)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">MCA Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/MCA.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                ...
                <tr>
                  ...
                  <td class="fw-semibold text-dark">BCA (Bachelor of Computer Applications)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">BCA Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BCA.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                      <i class="fa fa-file-pdf text-danger"></i> Download PDF
                    </a>
                  </td>
                </tr>
