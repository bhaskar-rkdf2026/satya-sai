<?php
$page_title = 'Physical Education - Outcome Based Curriculum - SSSUTMS';
...
$curricula = [
    [
        'category' => 'Physical Education Programs',
        'badge' => 'Physical Education',
        'filter' => 'pe',
        'items' => [
            ['title' => 'Bachelor of Physical Education (B.P.Ed.)', 'file' => 'BPED.pdf', 'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/Curriculum/BPED.pdf'],
            ['title' => 'Bachelor of Physical Education and Sports (B.P.E.S.)', 'file' => '', 'url' => '#'],
        ]
    ]
];

if (function_exists('get_dynamic_curricula')) {
    $curricula = get_dynamic_curricula('obc_Physical_Education', $curricula);
}
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #002B5B;">FACULTY OF PHYSICAL EDUCATION</h3>
            ...
            <div class="col-md-6">
              <div class="card h-100 border-0 rounded-4 p-4 shadow-sm" style="background: linear-gradient(135deg, #f0f7ff 0%, #e6f0fa 100%); border-left: 5px solid #002B5B !important;">
                ...
                <p class="small text-secondary mb-0 lh-base">
                  “To develop globally recognized world class professionals and educations in the field of sports sciences to have sustained impact on social progress and betterment.”
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card h-100 border-0 rounded-4 p-4 shadow-sm" style="background: linear-gradient(135deg, #fffbf0 0%, #fff6e6 100%); border-left: 5px solid #e67e23 !important;">
                ...
                <div class="small text-secondary mb-0 lh-base">
                  <p class="mb-1"><strong>1.</strong> To innovatively and strategically enhancing the department as leading role in the field of physical education and provides teacher education and education plus program.</p>
                  <p class="mb-1"><strong>2.</strong> To nurture quality physical education teachers as well as sports and health professionals as selfreliant life-long learners capable for integrating theory and practice to serve as role models.</p>
                  <p class="mb-0"><strong>3.</strong> To develop professionals to encourage personal and professionally healthy behaviours of the individuals.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
            <div class="d-flex flex-wrap align-items-center gap-2" id="categoryFilters">
              <button type="button" class="pe-tab-btn active" data-filter="all">All Programs (2)</button>
            </div>
          ...
          <div class="table-responsive pe-table-wrapper">
            <table class="pe-table obe-table">
              <thead>
                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const filterButtons = document.querySelectorAll('#categoryFilters .pe-tab-btn');
