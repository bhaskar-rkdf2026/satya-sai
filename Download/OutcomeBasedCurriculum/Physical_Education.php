<?php
$page_title = 'Faculty of Physical Education - Outcome Based Curriculum - SSSUTMS';
        ...
        <div class="academic-card bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.5rem;">Faculty of Physical Education</h3>
            ...
            <div class="col-md-6">
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #0b2545;">
                ...
                <p class="text-secondary small mb-0 lh-base" style="font-style: italic;">
                  "To develop globally recognized world class professionals and educators in the field of sports sciences to have sustained impact on social progress and betterment."
                </p>
              </div>
            </div>
              ...
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #475569;">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2" style="font-size: 0.84rem; color: #475569;">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="lh-sm">1. To innovatively and strategically enhance the department as a leading role in the field of physical education and provide teacher education and education plus programs.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">2. To nurture quality physical education teachers as well as sports and health professionals as self-reliant life-long learners capable of integrating theory and practice to serve as role models.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">3. To develop professionals to encourage personal and professionally healthy behaviours of individuals.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <table class="table table-hover align-middle mb-0 standard-table obe-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">B.P.Ed.</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">Bachelor of Physical Education Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BPED.pdf" target="_blank" class="btn-standard-doc text-nowrap">
