<?php
$page_title = 'Faculty of Life Sciences - Outcome Based Curriculum - SSSUTMS';
$banner_title = 'Faculty of Life Sciences';
        ...
        <div class="academic-card bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.5rem;">Faculty of Life Sciences</h3>
              ...
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #475569;">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2" style="font-size: 0.84rem; color: #475569;">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="lh-sm">1. The role of biological science is the discovery and integration of basic knowledge from multiple fields of study as they apply to living systems.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">2. Advances in basic and applied knowledge provide a nexus from which theory, technology, and policy arise.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">3. The Department is the hub of life science initiatives—advancing biological knowledge and developing sustainable solutions.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">4. All students need a diverse educational experience through which they can develop an appreciation of the connectedness of life across all scales of organization.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">5. We value the direct and intangible benefits that emerge from a diverse complement of research and teaching faculty.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <table class="table table-hover align-middle mb-0 standard-table obe-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">B.Sc. (Biology)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">B.Sc. Biology Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BSc_Bio.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                ...
                <tr>
                  ...
                  <td class="fw-semibold text-dark">B.Sc. (Microbiology)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">B.Sc. Microbiology Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BSc_Micro.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                      <i class="fa fa-file-pdf text-danger"></i> Download PDF
                    </a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">M.Sc. (Botany)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">M.Sc. Botany Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/MSc_Bot.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                      <i class="fa fa-file-pdf text-danger"></i> Download PDF
                    </a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">M.Sc. (Zoology)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">M.Sc. Zoology Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/MSc_Bot.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                      <i class="fa fa-file-pdf text-danger"></i> Download PDF
                ...
                <tr>
                  ...
                  <td class="fw-semibold text-dark">M.Sc. (Microbiology)</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">M.Sc. Microbiology Outcome Based Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/MSc_Micro.pdf" target="_blank" class="btn-standard-doc text-nowrap">
                      <i class="fa fa-file-pdf text-danger"></i> Download PDF
                    </a>
                  </td>
                </tr>
