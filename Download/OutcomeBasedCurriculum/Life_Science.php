...
$page_info = get_obe_page_info($pageKey, [
    ...
    'vision_title'   => 'VISION',
    'vision_text'    => 'The Department of Biological Sciences will be a recognized regional, national, and international leader in research, and in undergraduate and graduate education in life sciences.',
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'FACULTY OF LIFE SCIENCES'); ?></h3>
