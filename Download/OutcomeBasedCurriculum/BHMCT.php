<?php
$page_title = 'Faculty of Hotel Management & Catering Technology - Outcome Based Curriculum - SSSUTMS';
$banner_title = 'Faculty of Hotel Management & Catering Technology';
        ...
        <div class="academic-card bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.5rem;">Faculty of Hotel Management & Catering Technology</h3>
            ...
            <div class="col-md-6">
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #0b2545;">
                ...
                <p class="text-secondary small mb-0 lh-base" style="font-style: italic;">
                  "To develop excellent and world class managers and professionals for food and hospitality industries world over."
                </p>
              </div>
            </div>
              ...
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #475569;">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2" style="font-size: 0.84rem; color: #475569;">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="lh-sm">To develop professionals at different levels possessing hospitality skills, operational exposure and strategic outcomes for dealing with Food &amp; Hospitality Industries.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">Impart high quality culinary training, guest service standards, and international lodging management principles.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">Inculcate global hospitality etiquette and entrepreneurship capabilities.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <table class="table table-hover align-middle mb-0 standard-table obe-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">BHMCT</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">Bachelor of Hotel Management &amp; Catering Technology Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BHMCT .pdf" target="_blank" class="btn-standard-doc text-nowrap">
