<?php
$page_title = 'Faculty of Education - Outcome Based Curriculum - SSSUTMS';
        ...
        <div class="academic-card bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              ...
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.5rem;">Faculty of Education</h3>
              ...
              <div class="p-3 rounded-2 h-100" style="background: #ffffff; border: 1px solid #e2e8f0; border-left: 4px solid #475569;">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-2" style="font-size: 0.84rem; color: #475569;">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="lh-sm">1. To prepare teachers excelling in teaching and research methodology.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">2. To foster skills and attitude for teachers to discharge their duties and functions in such a way as to provide significant inputs in school education.</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <i class="fa fa-angle-right text-muted mt-1" style="font-size: 0.75rem;"></i>
                    <span class="lh-sm">3. To prepare teachers to fully utilize potentialities of information technology and communication methodology.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <table class="table table-hover align-middle mb-0 standard-table obe-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="fw-semibold text-dark">B.A. B.Ed.</td>
                  <td>
                    <span class="standard-badge me-2">Curriculum</span>
                    <span class="text-secondary small">Bachelor of Arts &amp; Bachelor of Education Integrated Curriculum</span>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo BASE_URL; ?>assets/images/Files/Link/Curriculum/BABEd.pdf" target="_blank" class="btn-standard-doc text-nowrap">
