...
$page_key = 'syllabus_BHMCT';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'BACHELOR OF HOTEL MANAGEMENT & CATERING TECHNOLOGY (BHMCT) SYLLABUS',
    'subheading'     => 'AICTE Approved 4-Year Professional Hospitality Curriculum',
    'badge_obe'      => 'Hotel Management & Catering',
    'badge_approval' => 'AICTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To cultivate world-class leaders in hospitality management, culinary arts, and tourism.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Provide dynamic experiential training combining luxury hotel operations, gastronomic mastery, and entrepreneurial management.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'BHMCT.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'BHMCT.php'); ?>" class="eng-sidebar-link">
