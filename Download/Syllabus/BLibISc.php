<?php
$page_title   = 'Faculty of Library & Information Science - Course Syllabus - SSSUTMS';
...
$groups = array (
  0 => 
  array (
    'title' => 'Bachelor of Library & Information Science (B.Lib.I.Sc. — 1-Year Degree)',
    ...
    array (
      ...
      array (
        'name' => 'First Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Lib.I.Sc. First Semester Course Syllabus',
        'url' => $BASE . 'SCHEMES/BLIB_MLIB%20SCH/BLIB_I.pdf',
      ),
      1 => 
      array (
        'name' => 'Second Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Lib.I.Sc. Second Semester Course Syllabus',
        'url' => $BASE . 'SCHEMES/BLIB_MLIB%20SCH/BLIB_II.pdf',
      ),
    ),
  ),
);
