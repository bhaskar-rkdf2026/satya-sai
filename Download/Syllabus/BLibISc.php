<?php
$page_title = 'Bachelor of Library & Information Science (B.Lib.I.Sc.) Syllabus - SSSUTMS';
...
$page_key = 'syllabus_BLibISc';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'BACHELOR OF LIBRARY & INFORMATION SCIENCE (B.LIB.I.SC.) SYLLABUS',
    'subheading'     => '1-Year Professional Curriculum in Library Systems & Digital Knowledge Management',
    'badge_obe'      => 'Library & Information Science',
    'badge_approval' => 'UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To educate modern information specialists and digital knowledge curation leaders.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Deliver comprehensive training in automated library systems, knowledge classification, and information curation.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'BLibISc.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'BLibISc.php'); ?>" class="eng-sidebar-link">
