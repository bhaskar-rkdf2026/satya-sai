<?php
$page_title   = 'B.Sc. Hospitality Management & Catering Science - Course Syllabus - SSSUTMS';
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'First Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] First Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_I.pdf',
      ),
      1 => 
      array (
        'name' => 'Second Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] Second Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_II.pdf',
      ),
      2 => 
      array (
        'name' => 'Third Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] Third Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_III.pdf',
      ),
      3 => 
      array (
        'name' => 'Fourth Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] Fourth Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_IV.pdf',
      ),
      4 => 
      array (
        'name' => 'Fifth Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] Fifth Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_V.pdf',
      ),
      5 => 
      array (
        'name' => 'Sixth Semester',
        'badge' => 'Syllabus',
        'desc' => 'B.Sc. [HMCS] Sixth Semester Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/SYLLABUS/SYLHMCS_VI.pdf',
      ),
    ),
  ),
);
