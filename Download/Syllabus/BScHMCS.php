<?php
$page_title = 'B.Sc. Hotel Management & Catering Science (HMCS) Syllabus - SSSUTMS';
$banner_title = 'B.Sc. (HMCS)';
...
$page_key = 'syllabus_BScHMCS';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'B.SC. HOTEL MANAGEMENT & CATERING SCIENCE (HMCS) SYLLABUS',
    'subheading'     => '3-Year Undergraduate Degree Program in Hospitality Operations',
    'badge_obe'      => 'Hotel Management & Catering Science',
    'badge_approval' => 'UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To empower skilled hospitality leaders in global culinary and hotel operations.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Deliver hands-on training in culinary arts, guest relations, and tourism operations.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'BScHMCS.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'BScHMCS.php'); ?>" class="eng-sidebar-link">
