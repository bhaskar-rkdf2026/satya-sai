<?php
$page_title = 'Faculty of Homoeopathy (BHMS) Syllabus - SSSUTMS';
$banner_title = 'BHMS';
...
$page_key = 'syllabus_BHMS';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'BACHELOR OF HOMOEOPATHIC MEDICINE & SURGERY (BHMS) SYLLABUS',
    'subheading'     => 'National Commission for Homoeopathy (NCH) Prescribed Medical Curriculum',
    'badge_obe'      => 'Faculty of Homoeopathy',
    'badge_approval' => 'NCH & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To establish premier clinical homoeopathic medical education and holistic healthcare delivery.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Train competent, compassionate homoeopathic physicians through rigorous clinical training and classical therapeutics.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'BHMS.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'BHMS.php'); ?>" class="eng-sidebar-link">
