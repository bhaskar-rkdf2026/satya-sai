<?php
$page_title   = 'Faculty of Paramedical Sciences - Course Syllabus - SSSUTMS';
...
$groups = array (
  0 => 
  array (
    'title' => 'Paramedical Sciences & Allied Health Courses (NEP 2020)',
    'icon' => 'fa-notes-medical',
    'items' => 
    array (
      0 => 
      array (
        'name' => 'Paramedical Sciences (Unified Syllabus)',
        'badge' => 'NEP 2020',
        'desc' => 'National Education Policy Unified Syllabus for Paramedical Sciences',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/NEP%202020%2027%20university%2014-compressed.pdf',
      ),
      1 => 
      array (
        'name' => 'BMLT (Bachelor in Medical Laboratory Technology)',
        'badge' => 'Degree',
        'desc' => 'Detailed 3-Year BMLT Course Syllabus & Diagnostic Training',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/NEP%202020%2027%20university%2014-compressed.pdf',
      ),
      2 => 
      array (
        ...
        'badge' => 'Degree',
        'desc' => 'Detailed 4.5-Year BPT Course Syllabus & Clinical Modules',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/NEP%202020%2027%20university%2014-compressed.pdf',
      ),
      3 => 
      array (
        ...
        'badge' => 'Diploma',
        'desc' => 'Detailed 2-Year DMLT Practical & Theoretical Syllabus',
        'url' => 'https://www.sssutms.co.in/cms/Areas/Website/Files/Link/NEP%202020%2027%20university%2014-compressed.pdf',
      ),
    ),
  ),
