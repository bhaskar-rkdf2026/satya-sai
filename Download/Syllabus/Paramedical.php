...
$page_key = 'syllabus_Paramedical';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'FACULTY OF PARAMEDICAL STUDIES SYLLABUS',
    'subheading'     => 'MP Paramedical Council Approved Syllabi for Allied Healthcare Programs',
    'badge_obe'      => 'Faculty of Paramedical Studies',
    'badge_approval' => 'MP Paramedical Council & UGC',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To develop skilled allied healthcare practitioners delivering vital medical diagnostic services.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Provide high-caliber clinical and laboratory training across diagnostic and therapeutic healthcare technologies.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'Paramedical.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'Paramedical.php'); ?>" class="eng-sidebar-link">
