...
$page_key = 'syllabus_PhysicalEducation';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'FACULTY OF PHYSICAL EDUCATION SYLLABUS',
    'subheading'     => 'NCTE Prescribed Syllabi for B.P.Ed. and B.P.E.S. Degree Programs',
    'badge_obe'      => 'Faculty of Physical Education',
    'badge_approval' => 'NCTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To inspire athletic excellence, sports science innovation, and holistic fitness leadership.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Deliver professional sports training, kinesiology, and sports pedagogy to nurture top sports leaders and coaches.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'PhysicalEducation.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'PhysicalEducation.php'); ?>" class="eng-sidebar-link">
          ...
          <div class="eng-sidebar-widget">
            ...
            $currentFile = 'PhysicalEducation.php';
