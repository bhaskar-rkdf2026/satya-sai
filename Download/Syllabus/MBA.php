...
$page_key = 'syllabus_MBA';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'MASTER OF BUSINESS ADMINISTRATION (MBA) SYLLABUS',
    'subheading'     => 'Postgraduate Management Curriculum (CBCS, Non-CBCS & Part-Time)',
    'badge_obe'      => 'Faculty of Management Studies',
    'badge_approval' => 'AICTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To develop visionary business leaders, strategic thinkers, and ethical managers.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Offer holistic management education emphasizing strategic problem-solving, corporate leadership, and global business practices.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'MBA.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'MBA.php'); ?>" class="eng-sidebar-link">
