...
$page_key = 'syllabus_Pharmacy';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'FACULTY OF PHARMACY SYLLABUS',
    'subheading'     => 'PCI Prescribed Syllabi for B.Pharm, M.Pharm and D.Pharm Programs',
    'badge_obe'      => 'Faculty of Pharmacy',
    'badge_approval' => 'PCI & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To be a center of excellence in pharmaceutical education, research, and healthcare delivery.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Nurture competent pharmacy professionals equipped with drug discovery, clinical knowledge, and professional ethics.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'Pharmacy.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'Pharmacy.php'); ?>" class="eng-sidebar-link">
