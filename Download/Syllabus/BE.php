...
$page_key = 'syllabus_BE';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'BACHELOR OF ENGINEERING (B.E.) SYLLABUS',
    'subheading'     => 'AICTE Model Curriculum, CBCS & University Syllabi across all Engineering Branches',
    'badge_obe'      => 'Faculty of Engineering & Technology',
    'badge_approval' => 'AICTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To impart quality technical education of international standards, produce innovative engineers and researchers, and foster technological advancement for sustainable societal growth.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Provide rigorous engineering curricula combining solid theoretical fundamentals with state-of-the-art laboratory practice and industry-driven research.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'BE.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'BE.php'); ?>" class="eng-sidebar-link">
