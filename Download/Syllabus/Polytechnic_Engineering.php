...
$page_key = 'syllabus_Polytechnic_Engineering';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'DIPLOMA IN ENGINEERING (POLYTECHNIC) SYLLABUS',
    'subheading'     => 'AICTE Approved 3-Year Technical Diploma Syllabi across Engineering Branches',
    'badge_obe'      => 'Polytechnic Division',
    'badge_approval' => 'AICTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To cultivate industry-ready diploma technicians and engineering practitioners.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Provide hands-on vocational and foundational engineering curricula for immediate industrial application.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'Polytechnic_Engineering.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'Polytechnic_Engineering.php'); ?>" class="eng-sidebar-link">
          ...
          <div class="eng-sidebar-widget">
            ...
            $currentFile = 'Polytechnic_Engineering.php';
