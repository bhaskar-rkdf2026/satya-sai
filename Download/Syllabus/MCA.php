...
$page_key = 'syllabus_MCA';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'MASTER OF COMPUTER APPLICATIONS (MCA) SYLLABUS',
    'subheading'     => '2-Year Master of Computer Applications CBCS & Advanced Curriculum',
    'badge_obe'      => 'Faculty of Computer Applications',
    'badge_approval' => 'AICTE & UGC Approved',
    'vision_title'   => 'VISION',
    'vision_text'    => 'To pioneer advanced computing education and create software architects driving global digital innovation.',
    'mission_title'  => 'MISSION',
    'mission_text'   => 'Empower students with comprehensive software development, machine learning, and algorithmic expertise.'
]);
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url('Download/OutcomeBasedCurriculum/' . 'MCA.php'); ?>" class="eng-sidebar-link">
            ...
            <a href="<?php echo base_url('Download/Scheme/' . 'MCA.php'); ?>" class="eng-sidebar-link">
