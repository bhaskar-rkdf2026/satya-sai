...
$banner_title = 'Ph.D. Notifications';
...
$page_key = 'doc_NotificationOfPhdAward';

// Dynamic Page Info
$page_info = get_obe_page_info($page_key, [
    'heading'        => 'NOTIFICATION OF PH.D. AWARD & RESEARCH',
    'subheading'     => 'Official Ph.D. Notifications, Course Work Schedules, Research Guidelines & Submission Documents',
    'badge_obe'      => 'Doctoral Research Division',
    'badge_approval' => 'UGC 2009/2016 Compliant',
    'vision_title'   => 'RESEARCH VISION',
    'vision_text'    => 'To foster world-class multidisciplinary research, innovative doctoral scholarship, and impactful academic discovery contributing to societal and global advancement.',
    'mission_title'  => 'RESEARCH MISSION',
    'mission_text'   => 'Deliver rigorous doctoral training, ensure highest standards of academic integrity, and support researchers with advanced facilities and expert mentorship.'
]);
      ...
      <div class="col-lg-8 col-xl-9">
          ...
          <div class="row g-3 mb-4" id="vision-mission-sec">
              ...
              <div class="col-md-6">
                <div class="eng-vm-card">
                  <h3 class="eng-vm-title">
                    <i class="fa fa-eye"></i> <?php echo htmlspecialchars($page_info['vision_title'] ?? 'RESEARCH VISION'); ?>
                  </h3>
            ...
            <?php if (!empty($page_info['mission_text'])): ?>
              <div class="col-md-6">
                <div class="eng-vm-card">
                  <h3 class="eng-vm-title">
                    <i class="fa fa-bullseye"></i> <?php echo htmlspecialchars($page_info['mission_title'] ?? 'RESEARCH MISSION'); ?>
                  </h3>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
          ...
          <div class="eng-search-box">
            ...
            <input type="text" id="phdDocSearch" class="form-control" placeholder="Search notification, ordinance, form...">
        ...
        <div class="eng-page-container">
          <div class="table-responsive">
            <table class="table eng-table" id="phdTable">
              <thead>
                <tr>
          ...
          <div class="no-results-box" id="noResultsBox">
            ...
            <h5 class="fw-bold">No Notification Found</h5>
            <p class="mb-0 text-muted small">No Ph.D. notification matches your current search/filter criteria.</p>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-xl-3">
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="eng-sidebar-widget">
            ...
            <a href="#phdTable" class="eng-sidebar-link">
            ...
            <?php if (!empty($page_info['vision_text'])): ?>
              <a href="#vision-mission-sec" class="eng-sidebar-link">
                <span><i class="fa fa-eye me-2 text-warning"></i> Research Vision</span>
              </a>
            <?php endif; ?>
            <a href="<?php echo base_url('Download/Forms.php'); ?>" class="eng-sidebar-link">
              <span><i class="fa fa-file-invoice me-2 text-info"></i> University Download Forms</span>
              <i class="fa fa-arrow-right small text-muted"></i>
            </a>
            <a href="<?php echo base_url('Download/E-Content.php'); ?>" class="eng-sidebar-link">
              <span><i class="fa fa-graduation-cap me-2 text-success"></i> E-Content & Digital Learning</span>
              <i class="fa fa-arrow-right small text-muted"></i>
            </a>
          </div>
          ...
          <div class="eng-sidebar-widget">
            ...
            $currentFile = 'NotificationOfPhdAward.php';
...
document.addEventListener('DOMContentLoaded', function () {
  const searchInput = document.getElementById('phdDocSearch');
  const clearBtn = document.getElementById('clearSearch');
  const filterBtns = document.querySelectorAll('.eng-filter-btn');
  const tableRows = document.querySelectorAll('#phdTable tbody tr');
