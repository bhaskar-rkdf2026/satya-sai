<?php
$page_title   = 'Faculty of Education - Curriculum Scheme - SSSUTMS';
...
$groups = [
  [
    'title' => 'B.Ed. — Bachelor of Education (2-Year Degree)',
    'icon'  => 'fa-chalkboard-user',
    'items' => [
      [
        'name'  => 'B.Ed. (CBCS Scheme)',
        'badge' => 'CBCS Scheme',
        'desc'  => 'I to IV Semester (w.e.f. Academic Session 2016-17)',
        'url'   => $BASE . 'SCHEMES/CBCS%20SCHEME/Scheme%20Education/SCBEDC_I_IV.pdf',
      ],
      [
        'name'  => 'B.Ed. Second Semester',
        'badge' => 'Non-CBCS',
        'desc'  => 'B.Ed. Second Semester Scheme (Non-CBCS)',
        'url'   => $BASE . 'SCHEMES/EDU/BEdscheme2sem..pdf',
      ],
      [
        'name'  => 'B.Ed. Second Year',
        'badge' => 'Non-CBCS',
        'desc'  => 'B.Ed. Second Year (III & IV Semester Scheme)',
        'url'   => $BASE . 'SCHEMES/EDU/bed32.pdf',
      ],
    ]
  ],
  [
    'title' => 'B.A. B.Ed. — Integrated Dual Degree (4-Year Programme)',
    'icon'  => 'fa-graduation-cap',
    'items' => [
      [
        'name'  => 'First Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. First Semester Teaching Scheme',
        'url'   => $BASE . 'BA_BED_Schem_I__sem_New_-__-_Copy_(2)_09072022_1212.pdf',
      ],
      [
        'name'  => 'Second Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Second Semester Teaching Scheme',
        'url'   => $BASE . 'BA_BED_Schem_II_sem_09072022_1212.pdf',
      ],
      [
        'name'  => 'Third Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Third Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEMES/CBCS%20SCHEME/Scheme%20Education/SCBA_Bedi_IIISem.pdf',
      ],
      [
        'name'  => 'Fourth Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Fourth Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEMES/CBCS%20SCHEME/Scheme%20Education/SCBABed_IVrr.pdf',
      ],
      [
        'name'  => 'Fifth Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Fifth Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEMES/babed%205%20sem.pdf',
      ],
      [
        'name'  => 'Sixth Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Sixth Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEMES/CBCS%20SCHEME/Scheme%20Education/SCBABed_VI.pdf',
      ],
      [
        'name'  => 'Seventh Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Seventh Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEME2021/Scheme%207sem.pdf',
      ],
      [
        'name'  => 'Eighth Semester',
        'badge' => 'Scheme',
        'desc'  => 'B.A. B.Ed. Eighth Semester Teaching Scheme',
        'url'   => $BASE . 'SCHEME/BA_BED_Schem_VIII.pdf',
      ],
    ]
  ]
];
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              <span class="standard-badge mb-2 d-inline-block">
                <i class="fa fa-book-open-reader me-1 text-secondary"></i> Teacher Education
              </span>
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.45rem;">Faculty of Education</h3>
              <p class="text-muted small mb-0">Official Curriculum &amp; Examination Matrices for B.Ed. and Integrated B.A. B.Ed. Programmes.</p>
            </div>
