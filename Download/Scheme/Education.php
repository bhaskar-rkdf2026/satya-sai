...
$page_info = get_obe_page_info($pageKey, [
    ...
    'subheading'     => 'Teaching & Examination Schemes for B.Ed., M.Ed. & B.A. B.Ed. Programs.',
    'badge_obe'      => 'Faculties & Departments',
    'badge_approval' => 'NCTE & UGC Approved'
]);

$page_title = $page_info['page_title'] ?? 'Education - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Faculty of Education';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Teaching & Examination Schemes for B.Ed., M.Ed. & B.A. B.Ed. Programs.'); ?></p>
            </div>
