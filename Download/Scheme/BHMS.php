        ...
        <div class="scheme-header-card p-4 mb-4">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-2">
            <span class="scheme-badge">
              <i class="fa fa-book"></i> FACULTY OF HOMOEOPATHY
            </span>
            <span class="badge bg-light text-dark border px-3 py-2">
              <i class="fa fa-university me-1 text-primary"></i> SSSUTMS
            </span>
          </div>
          <h2 class="h3 fw-bold text-dark mt-2 mb-1" style="color: #0b2545 !important;">BHMS</h2>
          <p class="text-muted mb-0">Bachelor of Homoeopathic Medicine & Surgery Scheme</p>
        </div>
...
<td>
&nbsp;&nbsp;
&nbsp;<a href="<?= base_url('assets/images/Files/Link/SYLLABUS/BHMSSC/SC_BHMSI.pdf') ?>" target="_blank" class="download-btn"><i class="fa fa-file-pdf"></i> First Year &nbsp;</a>
<a href="<?= base_url('assets/images/Files/Link/SYLLABUS/BHMSSC/SC_BHMSI.pdf') ?>" target="_blank" class="download-btn"><i class="fa fa-file-pdf"></i> (wef 2016-17)</a><span style="text-align: start;">&nbsp;</span>
&nbsp;
</td>
<td>
 &nbsp; Second Year&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; (wef 2017-18)&nbsp;
&nbsp;
&nbsp;
</td>
<td>
