<?php
$page_title = 'BHMS - Teaching & Examination Scheme - SSSUTMS';
$banner_title = 'BHMS';
    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-8 col-xl-9">
        ...
        <div class="eng-header-banner">
          ...
          <h2 class="h3 fw-bold text-white mb-2">FACULTY OF HOMOEOPATHY</h2>
          <p class="text-white-50 mb-0">Bachelor of Homoeopathic Medicine and Surgery (BHMS) - Teaching &amp; Examination Scheme</p>
        </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
          <div class="eng-search-box">
            ...
            <input type="text" id="schemeSearch" class="form-control" placeholder="Search program, year, or scheme...">
            <button type="button" id="clearSearch" class="clear-btn"><i class="fa fa-times-circle"></i></button>
          </div>
          <div class="text-muted small">
            Showing <span id="visibleCount" class="fw-bold text-dark">1</span> program
          </div>
        </div>

        <!-- Scheme Table Wrapper -->
        <?php if (function_exists('render_dynamic_scheme_table')) render_dynamic_scheme_table('scheme_BHMS'); ?>

<div class="eng-table-wrapper">
          <div class="eng-section-header">
            <h5 class="eng-section-title">
              <i class="fa fa-graduation-cap text-primary"></i> Scheme Details - Bachelor of Homoeopathic Medicine &amp; Surgery (BHMS)
            </h5>
            <span class="eng-section-badge">Degree Programme</span>
          </div>
          
          <div class="table-responsive">
            <table class="table align-middle eng-table scheme-table" id="schemeTable">
              <thead>
                <tr>
                  <th style="width: 70px;">SR. NO.</th>
                  <th class="text-start" style="min-width: 260px;">COURSE / PROGRAM</th>
                  <th class="text-center" style="width: 280px;">FIRST YEAR SCHEME</th>
                  <th class="text-center" style="width: 280px;">SECOND YEAR SCHEME</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      ...
                      <div>
                        <div>Bachelor of Homoeopathic Medicine &amp; Surgery</div>
                        <small class="text-muted fw-normal">BHMS Degree Programme</small>
                      </div>
                    </div>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SYLLABUS/BHMSSC/SC_BHMSI.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> First Year (W.e.f. 2016-17)</a>
                  </td>
                  <td class="text-center">
                    <a href="#" class="eng-download-btn"><i class="fa fa-file-pdf"></i> Second Year (W.e.f. 2017-18)</a>
                  </td>
                </tr>
              </tbody>
            </table>
