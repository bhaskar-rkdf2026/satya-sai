<?php
$page_title   = 'Library & Information Science (B.Lib.I.Sc.) - Curriculum Scheme - SSSUTMS';
$banner_title = 'Faculty of Library & Information Science';
...
$groups = [
  [
    'title' => 'B.Lib.I.Sc. — Bachelor of Library & Information Science (1-Year Programme)',
    'icon'  => 'fa-book-bookmark',
    'items' => [
      ['name' => 'First Semester',  'badge' => 'Scheme', 'desc' => 'B.Lib.I.Sc. First Semester Scheme of Study & Examination',  'url' => $BASE . 'SCHEMES/BLIB_MLIB%20SCH/BLIB_I.pdf'],
      ['name' => 'Second Semester', 'badge' => 'Scheme', 'desc' => 'B.Lib.I.Sc. Second Semester Scheme of Study & Examination', 'url' => $BASE . 'SCHEMES/BLIB_MLIB%20SCH/BLIB_II.pdf'],
    ]
  ]
];
?>
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              <span class="standard-badge mb-2 d-inline-block">
                <i class="fa fa-book-bookmark me-1 text-secondary"></i> Library Science
              </span>
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.45rem;">Bachelor of Library &amp; Information Science (B.Lib.I.Sc.)</h3>
              <p class="text-muted small mb-0">Official Schemes of Study &amp; Examination Matrices for 1-Year Professional Degree.</p>
            </div>
            <div class="mt-2 mt-md-0">
              <span class="standard-badge text-dark">
                <i class="fa fa-check-circle text-success me-1"></i> UGC Recognized
              </span>
            </div>
          </div>
