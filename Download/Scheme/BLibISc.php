    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-8 col-xl-9">
        ...
        <div class="eng-header-banner">
          ...
          <h2 class="h3 fw-bold text-white mt-2 mb-1">FACULTY OF LIBRARY &amp; INFORMATION SCIENCE</h2>
          <p class="text-white-50 mb-0">Bachelor of Library &amp; Information Science (B.Lib.I.Sc.) Examination Schemes</p>
        </div>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
          <div class="eng-search-box">
            ...
            <input type="text" id="schemeSearch" class="form-control" placeholder="Search semester or scheme...">
        ...
        <!-- B.Lib.I.Sc. Scheme Table -->
        <?php if (function_exists('render_dynamic_scheme_table')) render_dynamic_scheme_table('scheme_BLibISc'); ?>

<div class="eng-table-wrapper">
          <div class="eng-section-header">
            <h5 class="eng-section-title">
              <i class="fa fa-book text-primary"></i> B.Lib.I.Sc. Scheme &amp; Regulations
            </h5>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      ...
                      <span>First Semester (B.Lib.I.Sc.)</span>
                    </div>
                  </td>
                  <td class="text-center">
                    <span class="eng-course-chip">Semester I</span>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEMES/BLIB_MLIB SCH/BLIB_I.pdf') ?>" target="_blank" class="eng-download-btn btn-wide">
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      <i class="fa fa-file-text-o text-muted"></i>
                      <span>Second Semester (B.Lib.I.Sc.)</span>
                    </div>
                  </td>
                  <td class="text-center">
                    <span class="eng-course-chip">Semester II</span>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEMES/BLIB_MLIB SCH/BLIB_II.pdf') ?>" target="_blank" class="eng-download-btn btn-wide">
                      <i class="fa fa-file-pdf"></i> Download Scheme
                    </a>
                  </td>
                </tr>
