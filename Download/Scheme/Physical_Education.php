...
$pageKey = 'scheme_Physical_Education';

$page_info = get_obe_page_info($pageKey, [
    'page_title'     => 'Physical Education - Teaching & Examination Scheme - SSSUTMS',
    'banner_title'   => 'Physical Education Scheme',
    'banner_category'=> 'Teaching & Examination Scheme',
    'heading'        => 'FACULTY OF PHYSICAL EDUCATION',
    'subheading'     => 'Teaching & Examination Schemes for B.P.Ed. & M.P.Ed. Programs.',
    'badge_obe'      => 'Faculties & Departments',
    'badge_approval' => 'NCTE & UGC Approved'
]);

$page_title = $page_info['page_title'] ?? 'Physical Education - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Physical Education Scheme';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'FACULTY OF PHYSICAL EDUCATION'); ?></h3>
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Teaching & Examination Schemes for B.P.Ed. & M.P.Ed. Programs.'); ?></p>
            </div>
