    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-8 col-xl-9">
        ...
        <div class="eng-header-banner">
          ...
          <h2 class="h3 fw-bold text-white mb-2">FACULTY OF PHYSICAL EDUCATION</h2>
          <p class="text-white-50 mb-0">Bachelor of Physical Education (B.P.Ed.) &amp; B.P.E.S. Programmes - Teaching &amp; Examination Scheme</p>
        </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
          <div class="eng-search-box">
            ...
            <input type="text" id="schemeSearch" class="form-control" placeholder="Search course, program, or year...">
        ...
        <!-- Section 1: B.P.Ed. Scheme Table -->
        <?php if (function_exists('render_dynamic_scheme_table')) render_dynamic_scheme_table('scheme_Physical_Education'); ?>

<div class="eng-table-wrapper">
          <div class="eng-section-header">
            <h5 class="eng-section-title">
              <i class="fa fa-graduation-cap text-primary"></i> Bachelor of Physical Education (B.P.Ed.)
            </h5>
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      ...
                      <div>
                        <div>B.P.Ed. (CBCS)</div>
                        <small class="text-muted fw-normal">Choice Based Credit System</small>
                      </div>
                    </div>
                  </td>
                  <td>
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCBPEDCBCS.pdf') ?>" target="_blank" class="eng-download-btn btn-wide"><i class="fa fa-file-pdf"></i> I to IV Semester (CBCS)</a>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      <i class="fa fa-graduation-cap text-primary"></i>
                      <div>
                        <div>B.P.Ed. (Non-CBCS)</div>
                        <small class="text-muted fw-normal">Two Year Course (Old Scheme)</small>
                      </div>
                    </div>
                  </td>
                  <td>
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCBPEDG.pdf') ?>" target="_blank" class="eng-download-btn btn-wide"><i class="fa fa-file-pdf"></i> Two Year Course (Old Scheme)</a>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <!-- Section 2: B.P.E.S. Scheme Table -->
        <div class="eng-table-wrapper">
          <div class="eng-section-header">
            <h5 class="eng-section-title">
              <i class="fa fa-graduation-cap text-primary"></i> Bachelor of Physical Education &amp; Sports (B.P.E.S.)
            </h5>
            <span class="eng-section-badge">3 Year Programme</span>
          </div>
            ...
            <table class="table align-middle eng-table scheme-table">
              <thead>
                <tr>
                  ...
                  <th style="width: 200px;">COMPLETE SCHEME</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      <i class="fa fa-graduation-cap text-primary"></i>
                      <div>
                        <div>Bachelor of Physical Education and Sports (B.P.E.S.)</div>
                        <small class="text-muted fw-normal">Annual Scheme</small>
                      </div>
                    </div>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCBPE I (1).pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> B.P.E.S. I Year</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCBPE II (2).pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> B.P.E.S. II Year</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCBPE III.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> B.P.E.S. III Year</a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      ...
                      <div>
                        <div>Bachelor of Physical Education and Sports (B.P.E.S.)</div>
                        <small class="text-muted fw-normal">New Scheme</small>
                      </div>
                    </div>
                  </td>
                  <td class="text-center text-muted">-</td>
                  ...
                  <td class="text-center text-muted">-</td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/BPESSCH.pdf') ?>" target="_blank" class="eng-download-btn btn-wide"><i class="fa fa-file-pdf"></i> Complete Scheme of BPES</a>
                  </td>
                </tr>
              </tbody>
            </table>
