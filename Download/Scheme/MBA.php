    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-8 col-xl-9">
        ...
        <div class="eng-header-banner">
          ...
          <h2 class="h3 fw-bold text-white mb-2">FACULTY OF MANAGEMENT STUDIES</h2>
          <p class="text-white-50 mb-0">Master of Business Administration (MBA) - Teaching &amp; Examination Scheme</p>
        </div>
        ...
        <?php if (function_exists('render_dynamic_scheme_table')) render_dynamic_scheme_table('scheme_MBA'); ?>

<div class="eng-table-wrapper">
          <div class="eng-section-header">
            <h5 class="eng-section-title">
              <i class="fa fa-graduation-cap text-primary"></i> Scheme Details - Master of Business Administration (MBA)
            </h5>
            ...
            <table class="table align-middle eng-table" id="schemeTable">
              <thead>
                <tr>
                  ...
                  <th style="width: 110px;">III SEM</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/MBA_ICBCS.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> I Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/MBACII_SH.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> II Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCMBAC_III.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> III Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCMBAr_IV.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> IV Sem</a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      <i class="fa fa-graduation-cap text-primary"></i>
                      <div>
                        <div>MBA Non-CBCS</div>
                        <small class="text-muted fw-normal">(Old Scheme)</small>
                      </div>
                    </div>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SC_MBA_I.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> I Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/mba2.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> II Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/SCMBA_III.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> III Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/mba.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> IV Sem</a>
                  </td>
                  <td class="text-center text-muted">-</td>
                  <td class="text-center text-muted">-</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="eng-branch-name">
                      <i class="fa fa-graduation-cap text-primary"></i>
                      <div>
                        <div>MBA (Part Time)</div>
                        <small class="text-muted fw-normal">(Part Time Scheme)</small>
                      </div>
                    </div>
                  </td>
                  <td class="text-center text-muted">-</td>
                  ...
                  <td class="text-center text-muted">-</td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/mbaV_SH.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> V Sem</a>
                  </td>
                  <td class="text-center">
                    <a href="<?= base_url('assets/images/Files/Link/SCHEME/MBAVISH.pdf') ?>" target="_blank" class="eng-download-btn"><i class="fa fa-file-pdf"></i> VI Sem</a>
                  </td>
                </tr>
              </tbody>
            </table>
