...
$pageKey = 'scheme_Bachelor_Of_Laws_Llb';

$page_info = get_obe_page_info($pageKey, [
    'page_title'     => 'Faculty of Law - Teaching & Examination Scheme - SSSUTMS',
    'banner_title'   => 'Bachelor of Laws (LL.B.)',
    'banner_category'=> 'Teaching & Examination Scheme',
    'heading'        => 'FACULTY OF LAW',
    'subheading'     => 'Teaching & Examination Schemes for LL.B., B.A. LL.B. & B.B.A. LL.B. Programs.',
    'badge_obe'      => 'Faculty of Law',
    'badge_approval' => 'BCI & UGC Approved'
]);

$page_title = $page_info['page_title'] ?? 'Faculty of Law - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Bachelor of Laws (LL.B.)';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'FACULTY OF LAW'); ?></h3>
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Teaching & Examination Schemes for LL.B., B.A. LL.B. & B.B.A. LL.B. Programs.'); ?></p>
            </div>
