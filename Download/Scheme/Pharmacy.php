...
$page_info = get_obe_page_info($pageKey, [
    ...
    'subheading'     => 'Teaching, Examination Schemes & Detailed Course Curriculum for Pharmacy Programs.',
    'badge_obe'      => 'Faculties & Departments',
    'badge_approval' => 'PCI & UGC Approved'
]);

$page_title = $page_info['page_title'] ?? 'Faculty of Pharmacy - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Faculty of Pharmacy (B.Pharm / M.Pharm / D.Pharm)';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'SCHOOL OF PHARMACY'); ?></h3>
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Teaching, Examination Schemes & Detailed Course Curriculum for Pharmacy Programs.'); ?></p>
            </div>
