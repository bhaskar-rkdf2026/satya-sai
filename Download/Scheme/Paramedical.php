<?php
$page_title   = 'Faculty of Paramedical Sciences - Curriculum Scheme - SSSUTMS';
$banner_title = 'Faculty of Paramedical Sciences';
...
$groups = [
  [
    'title' => 'Paramedical Sciences & Allied Healthcare Programmes (NEP 2020)',
    'icon'  => 'fa-notes-medical',
    'items' => [
      [
        'name'  => 'Paramedical Sciences (Unified Scheme)',
        'badge' => 'NEP 2020',
        'desc'  => 'National Education Policy (NEP 2020) Unified Scheme for Paramedical & Allied Health',
        'url'   => $BASE . 'NEP%202020%2027%20university%2014-compressed.pdf',
      ],
      [
        'name'  => 'BMLT (Bachelor in Medical Laboratory Technology)',
        'badge' => 'Degree',
        'desc'  => 'Curriculum Scheme & Clinical Training Diagnostic Matrix (3-Year Degree + Internship)',
        'url'   => $BASE . 'NEP%202020%2027%20university%2014-compressed.pdf',
      ],
      [
        'name'  => 'BPT (Bachelor of Physiotherapy)',
        'badge' => 'Degree',
        'desc'  => 'Curriculum Scheme & Clinical Internship Matrix (4.5-Year Degree)',
        'url'   => $BASE . 'NEP%202020%2027%20university%2014-compressed.pdf',
      ],
      [
        'name'  => 'DMLT (Diploma in Medical Laboratory Technology)',
        'badge' => 'Diploma',
        'desc'  => 'Diploma Level Practical Laboratory & Diagnostic Training Scheme (2-Year Diploma)',
        'url'   => $BASE . 'NEP%202020%2027%20university%2014-compressed.pdf',
      ],
    ]
  ]
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              <span class="standard-badge mb-2 d-inline-block">
                <i class="fa fa-notes-medical me-1 text-secondary"></i> Paramedical Sciences
              </span>
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.45rem;">Faculty of Paramedical Sciences</h3>
              <p class="text-muted small mb-0">Official Schemes of Study &amp; Examination Matrices for Degree &amp; Diploma Courses (MP Paramedical Council).</p>
            </div>
            <div class="mt-2 mt-md-0">
              <span class="standard-badge text-dark">
                <i class="fa fa-check-circle text-success me-1"></i> MP Paramedical Council
              </span>
            </div>
          </div>
          ...
          <div class="row g-2 mb-3 align-items-center">
            <div class="col-md-6 col-lg-5">
              <div class="input-group">
                ...
                <input type="text" id="schemeFilter" class="form-control border-start-0 ps-0 filter-input" placeholder="Search course or programme...">
              </div>
            </div>
            ...
            <table class="table standard-table" id="schemeTable">
              <thead>
                <tr>
                  ...
                  <th style="width: 32%;">Programme / Course</th>
