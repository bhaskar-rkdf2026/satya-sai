...
$pageKey = 'scheme_Paramedical';

$page_info = get_obe_page_info($pageKey, [
    'page_title'     => 'Paramedical - Teaching & Examination Scheme - SSSUTMS',
    'banner_title'   => 'Faculty of Paramedical',
    'banner_category'=> 'Teaching & Examination Scheme',
    'heading'        => 'FACULTY OF PARAMEDICAL SCIENCES',
    'subheading'     => 'Paramedical Degree & Diploma Teaching & Examination Schemes.',
    'badge_obe'      => 'Faculties & Departments',
    'badge_approval' => 'MP Paramedical Council & UGC'
]);

$page_title = $page_info['page_title'] ?? 'Paramedical - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Faculty of Paramedical';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'FACULTY OF PARAMEDICAL SCIENCES'); ?></h3>
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Paramedical Degree & Diploma Teaching & Examination Schemes.'); ?></p>
            </div>
