...
$pageKey = 'scheme_Polytechnic_Engineering';
...
$page_info = get_obe_page_info($pageKey, [
    ...
    'heading'        => 'POLYTECHNIC (DIPLOMA ENGINEERING)',
    'subheading'     => 'Teaching & Examination Schemes for all Diploma Engineering Disciplines.',
    'badge_obe'      => 'Polytechnic Division',
    'badge_approval' => 'AICTE & UGC Approved'
]);

$page_title = $page_info['page_title'] ?? 'Diploma Engineering (Polytechnic) - Teaching & Examination Scheme - SSSUTMS';
$banner_title = $page_info['banner_title'] ?? 'Polytechnic Engineering';
        ...
        <div class="content-card shadow-sm border-0 rounded-4 bg-white p-4 mb-4">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom">
            <div>
              ...
              <?php endif; ?>
              <h3 class="fw-bold mb-1" style="color: #002B5B;"><?php echo htmlspecialchars($page_info['heading'] ?? 'POLYTECHNIC (DIPLOMA ENGINEERING)'); ?></h3>
              <p class="text-muted small mb-0"><?php echo htmlspecialchars($page_info['subheading'] ?? 'Teaching & Examination Schemes for all Diploma Engineering Disciplines.'); ?></p>
            </div>
