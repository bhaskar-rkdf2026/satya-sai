<?php
$page_title   = 'B.Sc. (HMCS) - Curriculum Scheme - SSSUTMS';
$banner_title = 'B.Sc. Hospitality Management & Catering Science';
...
$groups = [
  [
    'title' => 'B.Sc. [HMCS] — Hospitality Management & Catering Science (3-Year Degree)',
    'icon'  => 'fa-utensils',
    'items' => [
      ['name' => 'First Semester',   'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] First Semester Teaching Scheme',  'url' => $BASE . 'SCHEME/Scheme_HMCS_I_Sem_N.pdf'],
      ['name' => 'Second Semester',  'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] Second Semester Teaching Scheme', 'url' => $BASE . 'SCHEME/Scheme_HMCS_II_Sem_N.pdf'],
      ['name' => 'Third Semester',   'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] Third Semester Teaching Scheme',  'url' => $BASE . 'SCHEME/Scheme_HMCS_III_Sem_N.pdf'],
      ['name' => 'Fourth Semester',  'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] Fourth Semester Teaching Scheme', 'url' => $BASE . 'SCHEME/Scheme_HMCS_IV_Sem_N.pdf'],
      ['name' => 'Fifth Semester',   'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] Fifth Semester Teaching Scheme',  'url' => $BASE . 'SCHEME/Scheme_HMCS_V_Sem_N.pdf'],
      ['name' => 'Sixth Semester',   'badge' => 'Scheme', 'desc' => 'B.Sc. [HMCS] Sixth Semester Teaching Scheme',  'url' => $BASE . 'SCHEME/Scheme_HMCS_VI_Sem_N.pdf'],
    ]
  ]
];
?>
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center pb-3 mb-4 border-bottom" style="border-color: #e2e8f0 !important;">
            <div>
              <span class="standard-badge mb-2 d-inline-block">
                <i class="fa fa-utensils me-1 text-secondary"></i> Hospitality &amp; Catering
              </span>
              <h3 class="fw-bold mb-1" style="color: #0b2545; font-size: 1.45rem;">B.Sc. [HMCS] (Hospitality Management &amp; Catering Science)</h3>
              <p class="text-muted small mb-0">Official Schemes of Study &amp; Examination Matrices for 3-Year Undergraduate Programme.</p>
            </div>
          ...
          <div class="row g-2 mb-3 align-items-center">
            <div class="col-md-6 col-lg-5">
              <div class="input-group">
                ...
                <input type="text" id="schemeFilter" class="form-control border-start-0 ps-0 filter-input" placeholder="Search semester...">
              </div>
            </div>
