...
$faculty_page = get_faculty_page('Ayurveda');
$page_title = (!empty($faculty_page['title']) ? $faculty_page['title'] : 'Ayurveda - SSSUTMS');
$banner_title = $faculty_page['banner_title'] ?? 'Ayurveda';
$banner_category = $faculty_page['banner_category'] ?? 'Academic';
$facultyDocs = get_page_documents('faculty_Ayurveda');
        ...
        <div class="ayu-main-card">
          ...
          <div class="ayu-header-banner d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              ...
              <h3 class="fw-bold text-white mb-0 fs-3"><?php echo htmlspecialchars($faculty_page['faculty_name'] ?? 'FACULTY OF AYURVEDA'); ?></h3>
            </div>
          </div>
