...
$faculty_page = get_faculty_page('Science');
$page_title = (!empty($faculty_page['title']) ? $faculty_page['title'] : 'Science - SSSUTMS');
$banner_title = $faculty_page['banner_title'] ?? 'Science';
$banner_category = $faculty_page['banner_category'] ?? 'Academic';
$facultyDocs = get_page_documents('faculty_Science');
        ...
        <div class="sci-main-card">
          ...
          <div class="sci-header-banner d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              ...
              <h3 class="fw-bold text-white mb-0 fs-3"><?php echo htmlspecialchars($faculty_page['faculty_name'] ?? 'FACULTY OF SCIENCE'); ?></h3>
            </div>
          </div>
