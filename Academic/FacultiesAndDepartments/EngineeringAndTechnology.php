...
$faculty_page = get_faculty_page('EngineeringAndTechnology');
$page_title = (!empty($faculty_page['title']) ? $faculty_page['title'] : 'Engineering & Technology - SSSUTMS');
$banner_title = $faculty_page['banner_title'] ?? 'Engineering & Technology';
$banner_category = $faculty_page['banner_category'] ?? 'Academic';
$facultyDocs = get_page_documents('faculty_EngineeringAndTechnology');
        ...
        <div class="eng-main-card">
          ...
          <div class="eng-header-banner d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              ...
              <h3 class="fw-bold text-white mb-0 fs-3"><?php echo htmlspecialchars($faculty_page['faculty_name'] ?? 'SCHOOL OF ENGINEERING & TECHNOLOGY'); ?></h3>
            </div>
          </div>
