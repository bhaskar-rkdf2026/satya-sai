...
<style>
.csa-page-section { background-color: #f8fafc; }
.csa-main-card {
  background: #ffffff;
  border-radius: 20px;
...
.csa-course-table tbody tr:nth-child(even) { background: #f0f4f9; }
.csa-course-table tbody tr:nth-child(odd)  { background: #ffffff; }
.csa-course-table tbody tr:hover {
  background: #e8f0fb;
  transition: background 0.15s ease;
}
.csa-course-table tbody td {
  padding: 10px 14px;
  border-bottom: 1px solid #e2e8f0;
  color: #334155; vertical-align: middle;
}
.csa-course-table tbody td:first-child { font-weight: 600; color: #0b2545; }
.csa-badge-duration {
...
<section class="subpage-main-section csa-page-section py-4">
  <div class="container-fluid px-lg-5">
    <div class="row g-4 align-items-start">

      <!-- Main Content Area (Left) -->
      <div class="col-lg-8 col-xl-9">
        <div class="csa-main-card">

          <!-- Banner Header -->
          <div class="csa-header-banner d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
              <span class="badge text-white fw-bold uppercase mb-2 px-3 py-2 rounded-pill" style="background:rgba(245,158,11,0.25); border:1px solid rgba(245,158,11,0.4);">
                <i class="fa-solid fa-computer me-1"></i> Faculties &amp; Departments
              </span>
              <h3 class="fw-bold text-white mb-0 fs-3">FACULTY OF COMPUTER SCIENCE &amp; APPLICATION</h3>
            </div>
          </div>
          ...
          <div class="p-4">
            ...
            <div class="row g-3 align-items-stretch mb-4">
              <div class="col-sm-6 col-md-3">
                <div class="csa-stat-chip">
                  <div class="csa-stat-icon"><i class="fa-solid fa-user-graduate"></i></div>
                  <div>
                    <div class="text-muted extra-small uppercase fw-bold">PG Program</div>
                    <div class="fw-bold text-dark fs-6">M.C.A.</div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-3">
                <div class="csa-stat-chip">
                  <div class="csa-stat-icon"><i class="fa-solid fa-graduation-cap"></i></div>
                  <div>
                    <div class="text-muted extra-small uppercase fw-bold">UG Program</div>
                    <div class="fw-bold text-dark fs-6">B.C.A.</div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-3">
                <div class="csa-stat-chip">
                  <div class="csa-stat-icon"><i class="fa-solid fa-users"></i></div>
                  <div>
                    <div class="text-muted extra-small uppercase fw-bold">MCA Intake</div>
              ...
              <div class="col-sm-6 col-md-3">
                <div class="csa-stat-chip">
                  <div class="csa-stat-icon"><i class="fa-solid fa-users-line"></i></div>
                  <div>
                    <div class="text-muted extra-small uppercase fw-bold">BCA Intake</div>
                    <div class="fw-bold text-dark fs-6">60 Seats</div>
                  </div>
                </div>
              </div>
            </div>
