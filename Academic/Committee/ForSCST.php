...
$pageSeo = function_exists('get_committee_page_info') ? get_committee_page_info('ForSCST') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Committee for SC/ST - SSSUTMS';
...
$banner_title = $pageSeo['banner_title'] ?? ($pageSeo['page_title'] ?? 'Committee for SC/ST');
$banner_category = $pageSeo['banner_category'] ?? 'Academic';
$committeeDocs = function_exists('get_committee_documents') ? get_committee_documents('ForSCST') : [];
