...
$pageSeo = function_exists('get_committee_page_info') ? get_committee_page_info('AntiRagging') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Anti Ragging - SSSUTMS';
...
$banner_title = $pageSeo['banner_title'] ?? ($pageSeo['page_title'] ?? 'Anti Ragging');
$banner_category = $pageSeo['banner_category'] ?? 'Academic';
$committeeDocs = function_exists('get_committee_documents') ? get_committee_documents('AntiRagging') : [];
