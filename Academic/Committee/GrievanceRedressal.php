...
$pageSeo = function_exists('get_committee_page_info') ? get_committee_page_info('GrievanceRedressal') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Grievance Redressal - SSSUTMS';
...
$banner_title = $pageSeo['banner_title'] ?? ($pageSeo['page_title'] ?? 'Grievance Redressal');
$banner_category = $pageSeo['banner_category'] ?? 'Academic';
$committeeDocs = function_exists('get_committee_documents') ? get_committee_documents('GrievanceRedressal') : [];
