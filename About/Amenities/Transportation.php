...
$about_page = get_about_page('Transportation');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Transportation - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Transportation';
