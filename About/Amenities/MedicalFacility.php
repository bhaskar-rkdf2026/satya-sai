...
$about_page = get_about_page('MedicalFacility');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Medical Facility - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Medical Facility';
