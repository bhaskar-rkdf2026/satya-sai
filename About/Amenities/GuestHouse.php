...
$about_page = get_about_page('GuestHouse');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Guest House - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Guest House';
