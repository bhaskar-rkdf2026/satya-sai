...
$about_page = get_about_page('Chief_Vigilance_Officer');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Chief Vigilance Officer - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Chief Vigilance Officer';
