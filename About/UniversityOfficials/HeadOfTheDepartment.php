...
$about_page = get_about_page('HeadOfTheDepartment');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Head of Department - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Head of Department';
