...
$about_page = get_about_page('Finance_Officer');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Finance Officer - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Finance Officer';
