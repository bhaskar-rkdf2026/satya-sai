...
$about_page = get_about_page('BoardOfManagement');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Board of Management - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Board of Management';
