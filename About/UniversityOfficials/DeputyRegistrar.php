...
$about_page = get_about_page('DeputyRegistrar');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Deputy Registrar - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Deputy Registrar';
