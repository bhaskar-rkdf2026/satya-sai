...
$about_page = get_about_page('FinanceCommittee');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Finance Committee - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Finance Committee';
