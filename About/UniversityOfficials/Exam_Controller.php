...
$about_page = get_about_page('Exam_Controller');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Exam Controller - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Exam Controller';
