...
$about_page = get_about_page('sop');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'School of Pharmacy - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'School of Pharmacy';
        ...
        <div class="content-card">
          <div class="content-card-body">
            ...
            <div class="text-center mb-4">
              ...
              <h1 class="h2 fw-bold inst-title-bar" style="color:#1a3c6e;">School of Pharmacy</h1>
            ...
            <div class="row g-4 mb-4 align-items-stretch">
              <div class="col-md-4">
                <div class="principal-card h-100">
                  <div class="principal-img-wrap">
                    <img src="<?php echo BASE_URL; ?>assets/images/Files/Link/registar_(1)_30012026_1145.jpg"
                         alt="Principal Ã¢â‚¬â€œ School of Pharmacy"
              ...
              <div class="col-md-8">
                <div class="message-card">
                  ...
                  <p>At the School of Pharmacy, our focus is on delivering quality pharmaceutical education that integrates strong theoretical foundations with practical training.</p>
                  <p>We aim to develop competent, ethical, and socially responsible pharmacists who can meet the evolving needs of healthcare and the pharmaceutical industry.</p>
                  <p class="mb-0">With experienced faculty members, modern laboratories, and a student-centric learning environment, the School of Pharmacy is committed to academic excellence and professional growth of every learner.</p>
                </div>
              </div>
            </div>
              ...
              <div class="row g-3">
                <div class="col-md-4 col-sm-6">
                  <img src="<?php echo BASE_URL; ?>assets/images/Files/Link/pharmacy_campus_activity.jpg"
                       alt="Campus Activity" class="gallery-img"
                       onerror="this.src='<?php echo BASE_URL; ?>assets/images/gallery/3/img-26.jpg'">
                </div>
                <div class="col-md-4 col-sm-6">
                  <img src="<?php echo BASE_URL; ?>assets/images/Files/Link/pharmacy_lab_students.jpg"
                       alt="Students Group" class="gallery-img"
                       onerror="this.src='<?php echo BASE_URL; ?>assets/images/gallery/4/img-19.jpg'">
                </div>
                <div class="col-md-4 col-sm-6">
                  <img src="<?php echo BASE_URL; ?>assets/images/Files/Link/pharmacy_college_event.jpg"
                       alt="College Event" class="gallery-img"
                       onerror="this.src='<?php echo BASE_URL; ?>assets/images/slider/aamh(2).jpg'">
                </div>
              </div>
            </div>
