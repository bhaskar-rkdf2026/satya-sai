...
$about_page = get_about_page('MOU');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Memorandum of Understanding (MoU) - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'MOU';
