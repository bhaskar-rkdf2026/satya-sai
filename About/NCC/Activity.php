...
$about_page = get_about_page('Activity');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'NCC Activity - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Activity';
