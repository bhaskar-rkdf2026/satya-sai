...
$about_page = get_about_page('Ordinances');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Ordinances - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Ordinances';
