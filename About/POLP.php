...
$about_page = get_about_page('POLP');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Polytechnic Pharmacy - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Polytechnic Pharmacy';
