...
$about_page = get_about_page('Central_Facilities');
$page_title = (!empty($about_page['title']) ? $about_page['title'] : 'Central Facilities - SSSUTMS');
$banner_title = $about_page['banner_title'] ?? 'Central Facilities';
