...
$pageSeo = function_exists('get_examination_page_info') ? get_examination_page_info('Results') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Examination Results - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Examination Results';
