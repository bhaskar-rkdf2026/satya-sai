...
$pageSeo = function_exists('get_examination_page_info') ? get_examination_page_info('ExamNotifications') : [];
$page_data = $pageSeo;
$meta_title = !empty($pageSeo['meta_title']) ? $pageSeo['meta_title'] : 'Exam Notifications - SSSUTMS';
...
$banner_title = $pageSeo['page_title'] ?? 'Exam Notifications';
